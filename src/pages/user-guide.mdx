...
You can skip the [Lexical structure] part and just move to [Intro](#intro).
...
Most of the infix operators are left-associative.
...
<details>
  ...
  <blockquote>
    Planned to add custom operators in the future, likely it will be similar to how Swift does it.
...
import PrecedenceTable from '../_partials/grammar/_precedence-table.mdx'
